...
Danish citizen, married to Singaporean. LTVP-Plus holder, eligible to work in Singapore on LOC. Pursuing PR.\\ 
...
\descript{Software and Embedded (electronics engg.)}
\location{6th sem. (2018 – 2021) | Aarhus University}
...
\location{SoC, FPGA: Languages, build and test systems}
VHDL, HLS/SDS
\bluebullet{} Xilinx Vivado, SDK, SDSoC, Vitis
\sectionspace % Some whitespace after the section

\location{Cloud, Linux, DevOps, Databases, Web, Protocol stacks}
AWS
...
\location{Analysis, visualization, DSP, Computer Vision, etc.}
\inlinefocus{Matlab Toolboxes:} Symbolic Math, Filter Design, DSP, Image Processing, Computer Vision, Control System
\bluebullet \inlinefocus{Python libraries:} NumPy, SciPy, Pandas, Scikit-learn, Keras, Matplotlib, Seaborn
...
\bluebullet \inlinefocus{English} fluent
\bluebullet \inlinefocus{German} proficient (B2/C1)
\bluebullet \inlinefocus{Mandarin} basic.
...
\descript{| Assist. Analyst (telecoms.) }
